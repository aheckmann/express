...
dsl.configure(function(){
  dsl.use(require('express/plugins/view').View)
  dsl.use(require('express/plugins/cache').Cache)
  dsl.use(require('express/plugins/redirect').Redirect)
  dsl.use(require('express/plugins/body-decoder').BodyDecoder)
})
